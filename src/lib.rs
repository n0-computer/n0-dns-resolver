...
pub use self::dnssec::{
    ...
    ResourceRecord, SignedRrset, TrustAnchor, build_dnssec_query, key_tag, prove_no_ds,
    prove_nodata, prove_nxdomain, prove_wildcard, verify_chain, verify_chain_with_anchors,
